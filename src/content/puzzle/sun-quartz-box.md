...
difficulty: "Medium"
reward: "Sun Quartz + Leatherbound Notebook"
puzzleType: "symbol"
chapter: 3
requirements: ["Access East Wing 2F", "Corrosive from the Conference Room"]
code: "Star → Sun → Moon → Sun"
steps:
  - title: "Get the Corrosive"
    detail: "Pick up the corrosive from the cabinet in the Conference Room on East Wing 2F."
  - title: "Travel to the Lead Researcher's Office"
    detail: "Use the corrosive on the Sun Quartz Box's padlock to melt it."
  - title: "Find the symbol clues"
    detail: "Check the photos and documents on the wall for the correct sequence."
  - title: "Enter the code and collect rewards"
    detail: "Input Star → Sun → Moon → Sun to receive the Sun Quartz and the Leatherbound Notebook."
faq:
  - question: "Where is the Sun Quartz Puzzle Box in Resident Evil Requiem?"
